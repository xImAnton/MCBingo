...
public class BingoSettings {
    ...
    private void setupGui() {
        ...
        for (int i = 45; i < 48; i++) {
            inv.setItem(i, buttonField("Presets", new String[]{"Die Presets für dieses Bingo-Spiel"}, "Klicken zum öffnen.", Material.PINK_STAINED_GLASS_PANE));
        }
        inv.setItem(48, borderItem());
        inv.addItem(buttonField(ChatColor.RED + "Close", new String[]{}, "Klicken zum schließen.", Material.BARRIER));
        inv.setItem(50, borderItem());
        for (int i = 51; i < 54; i++) {
            inv.setItem(i, buttonField("Spiel starten", new String[]{"Das Bingo-Spiel mit den aktuellen", "Einstellungen starten."}, "Klicken zum starten.", Material.YELLOW_STAINED_GLASS_PANE));
        }
    }
    ...
    public static ItemStack descriptionField(String title, String[] description, String action, Material material) {
        ItemStack item = new ItemStack(material);
        ItemMeta meta = item.getItemMeta();
        meta.setDisplayName(ChatColor.GREEN + title);
        ArrayList<String> descWithColor = new ArrayList<>();
        for (String line : description) {
            descWithColor.add(ChatColor.GRAY + line);
        }
        if (action != null) {
            descWithColor.add(" ");
    ...
    public static ItemStack toggleField(String title, boolean ticked) {
        Material mat;
        if (ticked) {
    ...
    public static ItemStack counterField(String title, int index) {
        ...
        desc.add(ChatColor.GRAY + "Wert: " + index);
        desc.add(" ");
    ...
    public static ItemStack buttonField(String title, String[] desc, String action, Material color) {
